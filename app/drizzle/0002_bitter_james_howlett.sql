...
CREATE TABLE `__new_chord_shapes` (
	`id` text PRIMARY KEY NOT NULL,
	`chord_id` text NOT NULL,
...
--> statement-breakpoint
INSERT INTO `__new_chord_shapes`("id", "chord_id", "tuning", "base_fret") SELECT "id", "chord_id", "tuning", "base_fret" FROM `chord_shapes`;--> statement-breakpoint
DROP TABLE `chord_shapes`;--> statement-breakpoint
ALTER TABLE `__new_chord_shapes` RENAME TO `chord_shapes`;